...
//     void readValue(std::string & src, DataSourceType< DataSourceTypeId::Timestamp    > & dest, ColumnInfo & column_info);
//     void readValue(std::string & src, DataSourceType< DataSourceTypeId::TimestampTz  > & dest, ColumnInfo & column_info);
