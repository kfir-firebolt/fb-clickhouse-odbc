...
//     void readValue(DataSourceType< DataSourceTypeId::Timestamp    > & dest, ColumnInfo & column_info);
//     void readValue(DataSourceType< DataSourceTypeId::TimestampTz  > & dest, ColumnInfo & column_info);
